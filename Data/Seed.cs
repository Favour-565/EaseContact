...
using SQ20.Net_Wee7_8_Task.Enum;
        ...
        public static void SeedData(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                        ...
                        new Experience
                        {
                            ...
                            Skills = new List<Skill>
                            {
                                new Skill
                                {
                                    ...
                                    Description = "Website Frontend Design"
                                },
                                new Skill
                                {
                                    Name = "Backend Development",
                                    Description = "API, MVC.NET"
                                }
                ...
                if (!context.Portfolios.Any())
                {
                    ...
                    context.Portfolios.AddRange(Projects);
                    context.SaveChanges();
                }
                ...
                if (!context.Abouts.Any())
                {
                    var abouts = new List<About>
                    {
                        new About()
                        {
                            Name = "Favour Ezeh",
                            Description =
                                " I am a versatile Embedded Systems and Software Engineer, adept in hardware design and passionate about creating innovative and user-friendly websites. Proficient in HTML, CSS, JavaScript, and various web development tools, I seamlessly integrate software solutions into dynamic web applications. Committed to delivering high-quality work with keen attention to detail, my portfolio reflects the successful fusion of embedded systems and web development expertise.\r\n"
                        },
                        new About()
                        {
                            Name = "Favour Ezeh",
                            Description = "I am Adept in the .net framework. I am confident and smart. "
                        }
                ...
                if (!context.Skills.Any())
                {
                    var skills = new List<Skill>
                    {
                        ...
                        new Skill()
                        {
                            ...
                            Description = "Shaping IoT Experiences with Innovative Solutions.\r\n\r\nCrafting Innovative Embedded Devices",
                            ProficiencyLevel = ProficiencyLevel.Advanced,
                            CreatedAt = new DateTime(2021, 02, 20),
                            UpdatedAt = new DateTime(2022, 03, 26),
                        },
                ...
                if (!context.Socials.Any())
                {
                    var socials = new List<Social>
                    {
                        ...
                        new Social()
                        {
                            ...
                            /*AppUser = new AppUser()
                            {
                                FullName = "Favour Ezeh",
                                DateOfBirth = new DateTime(2001, 06, 26),
                                Nationality = "Nigerian",
                                Address = "10, victoria street, Era road, Lagos",
                                PhoneNumber = "08127072429",
                                Email = "favourezeh@gmail.com"
                            },*/
                        ...
                        new Social()
                        {
                            ...
                            /*AppUser = new AppUser()
                            {
                                ...
                                Address = "12th street, east coast, illinois",
                                PhoneNumber = "08127072429",
                                Email = "favourezeh@gmail.com"
                            },*/
                            CreatedAt = new DateTime(2021, 02, 20),
